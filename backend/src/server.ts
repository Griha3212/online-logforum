...
// Create HTTPS server.
const privateKey = fs.readFileSync(path.resolve('src/ssl/online.logforum.ru.key'));
const certificate = fs.readFileSync(path.resolve('src/ssl/online.logforum.ru.crt'));
